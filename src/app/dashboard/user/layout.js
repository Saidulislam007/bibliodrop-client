...
export default function UserLayout({ children }) {
  ...
  // 🔒 লোডিং গেটওয়ে (লাইট মোড থিম ভাই)
  ...
  // অ্যাক্সেস কন্ট্রোল (লাইট মোড থিম ভাই)
  ...
  {menuItems.map((item) => {
    ...
    <div className="min-h-screen bg-slate-50 text-slate-800 flex font-sans overflow-hidden">
      ...
      {/* 🧭 বাম পাশের ইউজার সাইডবার (লাইট মোড রেন্ডার) */}
      ...
      <aside className="w-64 bg-white border-r border-slate-200 p-5 flex flex-col gap-6 hidden lg:flex flex-shrink-0 min-h-screen sticky top-0 shadow-sm">
        ...
        {/* ইউজার প্রোফাইল কার্ড উইজেট - সাদা ব্যাকগ্রাউন্ড ও সফট শ্যাডো ভাই */}
...
{/* 📱 ছোট ডিভাইসের জন্য প্রিমিয়াম বটম নেভিগেশন বার (Mobile Bottom Menu) */}


      {/* 🖥️ ডানপাশের ডাইনামিক কন্টেন্ট এরিয়া (লাইট মোড কন্টেইনার) */}
